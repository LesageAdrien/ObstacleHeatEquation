...
simulation = ccs.Simulator(int(scr_size[0]/solver_screen_resolution_ratio), int(scr_size[1]/solver_screen_resolution_ratio), circlepos= circlepos, circleradius= circleradius)
